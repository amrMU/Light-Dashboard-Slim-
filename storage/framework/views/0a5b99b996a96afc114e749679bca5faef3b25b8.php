					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<a href="<?php echo e(URL::to('/')); ?>/admin/countries/<?php echo e(@$country->id); ?>/edit"><li class="fa fa-pencil btn btn-warning"></li></a>
								
							</td>
							<td>
								
								<?php echo $__env->make('admin.countries.delete_model', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
