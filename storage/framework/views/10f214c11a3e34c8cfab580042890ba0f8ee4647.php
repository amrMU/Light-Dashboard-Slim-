  ...
  <div class="container">
    <div class="slim-pageheader">
      <ol class="breadcrumb slim-breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?php echo e(URL::to('/admin/countries')); ?>">countries</a></li>
      ...
      <?php echo Form::open(['method' => 'PUT', 'url' => URL::to('admin/countries').'/'.@$country->id, 'class' => 'form-horizontal']); ?>
        ...
        <div class="container">
          ...
          <div class="row row-sm mg-10">
              <div class="col-9 col-sm-8 col-xl-12">
                ...
                <input type="text" name="name_ar" class="form-control " placeholder="Enter name" required value="<?php echo e(@$country->name_ar); ?>">
              </div><!-- col-8 -->
             ...
             <div class="row row-sm mg-10">
              <div class="col-9 col-sm-8 col-xl-12">
                <label title="name country ">name: <span class="tx-danger">*</span></label>
                <input type="text" name="name_en" class="form-control " placeholder="Enter name" required value="<?php echo e(@$country->name_en); ?>">
              </div><!-- col-8 -->
            </div><!-- row -->
