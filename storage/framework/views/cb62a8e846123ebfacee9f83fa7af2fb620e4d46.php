...
<div class="slim-mainpanel">
  <div class="container">
    <div class="slim-pageheader">
     ...
     <?php echo Form::open(['method'=>'PUT','url'=>'admin/faqs/'.$faq->id,'class'=>"form-horizontal" ,'role'=>"form",'files'=>'true']); ?>
            ...
            <div class="row row-sm mg-10">
              <div class="col-9 col-sm-8 col-xl-12">
                <label  ">Title Ar: <span class="tx-danger">*</span></label>
                  <input type="text" class="form-control" name="title_ar" value="<?php echo e(@$faq->title_ar); ?>">
              </div><!-- col-8 -->
            ...
            <div class="row row-sm mg-10">
              <div class="col-9 col-sm-8 col-xl-12">
                <label  ">Title En: <span class="tx-danger">*</span></label>
                 <input type="text" class="form-control" name="title_en" value="<?php echo e(@$faq->title_en); ?>">
              </div><!-- col-8 -->
            </div><!-- row -->
            ...
            <div class="row row-sm mg-10">
              <div class="col-9 col-sm-8 col-xl-12">
                <label  ">Content ar: <span class="tx-danger">*</span></label>
                 <textarea id="editor1" class="form-control" name="content_ar"><?php echo e(@$faq->content_ar); ?></textarea>
              </div><!-- col-8 -->
            </div><!-- row -->
            ...
            <div class="row row-sm mg-10">
              <div class="col-9 col-sm-8 col-xl-12">
                <label  ">Content En: <span class="tx-danger">*</span></label>
                 <textarea id="editor2" class="form-control" name="content_en"><?php echo e(@$faq->content_en); ?></textarea>
              </div><!-- col-8 -->
            </div><!-- row -->
