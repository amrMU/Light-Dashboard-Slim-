...
<div class="slim-mainpanel">
  <div class="container">
    <div class="slim-pageheader">
     ...
     <?php echo Form::open(['method'=>'PUT','url'=>'admin/categories/'.$info->id,'class'=>"form-horizontal" ,'role'=>"form",'files'=>'true']); ?>
              ...
              <div class="col-9 col-sm-8 col-xl-9">
                  ...
                  <div class="col-9 col-sm-8 col-xl-12">
                    <label title="name country ">name ar: <span class="tx-danger">*</span></label>
                     <input type="text" name="name_ar" class="form-control" value="<?php echo e(@$info->name_ar); ?>">
                  </div><!-- col-8 -->
                </div><!-- row -->
              </div><!-- col-8 -->
              <div class="col-9 col-sm-8 col-xl-3">
                 <img src="<?php echo e(URL::to('/')); ?><?php echo e($info->icon); ?>" class="img-fluid rounded">
              </div><!-- col-8 -->
            </div><!-- row -->
              ...
              <div class="col-9 col-sm-8 col-xl-9">
                ...
                <div class="row row-sm mg-10">
                  <div class="col-9 col-sm-8 col-xl-12">
                    ...
                    <input type="text" name="name_en" class="form-control" value="<?php echo e(@$info->name_en); ?>">
                  </div><!-- col-8 -->
                </div><!-- row -->
