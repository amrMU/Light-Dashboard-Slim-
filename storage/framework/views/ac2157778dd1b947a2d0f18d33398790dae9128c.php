...
<div class="slim-mainpanel">
  <div class="container">
    ...
    <?php endif; ?>
    <form method="post" action="<?php echo e(URL::to('admin/admins/'.$admin->id)); ?>"   enctype='multipart/form-data' data-parsley-validate>
      <div class="slim-mainpanel">
        <div class="container row">
            ...
            <div class="form-group mg-b-10">
              <div class="row row-sm">
                <div class="col-9 col-sm-8 col-xl-12">
                  ...
                  <input type="text" name="name" class="form-control " placeholder="Enter name" required value="<?php echo e(@$admin->name); ?>">
                </div><!-- col-8 -->
              </div><!-- row -->
            </div>
            <div class="form-group mg-b-10">
              <div class="row row-sm">
                <div class="col-9 col-sm-8 col-xl-12">
                  ...
                  <input type="email" name="email" class="form-control " placeholder="Enter Email" required value="<?php echo e(@$admin->email); ?>">
                </div><!-- col-8 -->
              </div><!-- row -->
            </div>
            <div class="form-group mg-b-10">
          ...
          <div class="col-xl-3">
           <img src="<?php echo e(URL::to('/')); ?>/<?php echo e(@$admin->image); ?>" class="img-fluid" alt="">
         </div>
       </div>
     </form>
