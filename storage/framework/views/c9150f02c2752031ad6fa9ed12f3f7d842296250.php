...
<div class="slim-mainpanel">
  <div class="container">
   ...
   <?php echo Form::open(['method'=>'PUT','url'=>'admin/cities/'.$city->id,'class'=>"form-horizontal" ,'role'=>"form",'files'=>'true']); ?>
          ...
          <div class="form-group mg-b-10">
            ...
            <div class="row row-sm mg-10">
              <div class="col-9 col-sm-8 col-xl-12">
                ...
                <option value="<?php echo e(@$country->id); ?>" <?php if($country->id == $city->country_id): ?> selected <?php endif; ?>><?php echo e(@$country->name_ar); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </select>
             ...
             <div class="row row-sm mg-10">
              <div class="col-9 col-sm-8 col-xl-12">
                ...
                <input type="text" class="form-control" name="name_ar" value="<?php echo e(@$city->name_ar); ?>">
              </div><!-- col-8 -->
            </div><!-- row -->
