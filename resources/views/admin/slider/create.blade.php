...
<div class="slim-mainpanel">
  <div class="container">
    ...
    {{-- start form  --}}
    {!! Form::open(['method'=>'post','url'=>'admin/slider','class'=>"form-horizontal" ,'role'=>"form",'files'=>'true']) !!}
      <div class="slim-mainpanel">
        <div class="container">
             ...
             <div class="row row-sm mg-10">
              <div class="col-9 col-sm-8 col-xl-12">
                <label  ">URL: <span class="tx-danger">*</span></label>
                  <input type="text" name="url" class="form-control input-lg"  placeholder="URL visit" value="{{ Request::old('url') }}">
              </div><!-- col-8 -->
            </div><!-- row -->
