<a href="" class="btn btn-danger" data-toggle="modal" data-target="#deleteslider{{ @$slider->id }}"><li class="fa fa-trash-o"></li></a>
		...
		<div class="modal-dialog modal-lg" role="document">
			...
			<div class="modal-content tx-size-sm">
				...
				<div class="modal-footer">
					...
					<a href="{{URL::to('/')}}/admin/slider/{{@$slider->id}}/delete" class="btn btn-primary">Delete</a>
				</div>
				</div>
