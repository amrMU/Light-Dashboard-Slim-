...
<head>
  ...
  <link href="{{URL::to('/assets')}}/lib/fullcalendar/css/fullcalendar.css" rel="stylesheet">

  <link href="{{URL::to('/assets')}}/lib/datatables/css/jquery.dataTables.css" rel="stylesheet">
  
  <link href="{{URL::to('/assets')}}/lib/medium-editor/css/medium-editor.css" rel="stylesheet">
  <link href="{{URL::to('/assets')}}/lib/medium-editor/css/default.css" rel="stylesheet">

  <link href="{{URL::to('/assets')}}/lib/summernote/css/summernote-bs4.css" rel="stylesheet">
  
  {{-- Component --}}
     <link href="{{URL::to('/assets')}}/lib/bootstrap-tagsinput/css/bootstrap-tagsinput.css" rel="stylesheet">

  {{-- Component --}}
  <!-- Slim CSS -->
  <link rel="stylesheet" href="{{URL::to('/assets')}}/css/slim.css">
  {{-- <link rel="stylesheet" href="{{URL::to('/assets')}}/slim.one.css"> --}}
...
<body >
  ...
  <div class="slim-header">
    <div class="container">
      <div class="slim-header-left">
        <h2 class="slim-logo"><a href="{{ URL::to('/admin/home') }}">{{@$setting->site_name}}<span>.</span></a></h2>
      ...
      <div class="slim-header-right">
        ...
        <div class="dropdown dropdown-c">
          ...
          <div class="dropdown-menu dropdown-menu-right">
            <nav class="nav">
              <a href="{{ URL::to('/admin/settings') }}" class="nav-link"><i class="icon ion-ios-gear"></i> General Settings</a>
              <a href="{{ URL::to('/admin/user/reset_password') }}" class="nav-link"><i class="icon ion-ios-gear"></i> Account Settings</a>
              <a href="{{URL::to('/admin/logout')}}" class="nav-link"><i class="icon ion-forward"></i> Sign Out</a>
            </nav>
          </div><!-- dropdown-menu -->
        </div><!-- dropdown -->
      </div><!-- header-right -->
      ...
      <ul class="nav">
        ...
        <li class="nav-item with-sub ">
          <a class="nav-link" href="#">
            ...
            <span>More</span> &nbsp;
             {{-- //contact us requests count --}}
            @if($contactus_requests_count > 0)
            <i class="fa fa-bell-o text-primary">{{ @$contactus_requests_count }}</i>
            @endif
            {{-- //contact us requests count --}}
          ...
          <div class="sub-item ">
            <ul>
              <li class="sub-with-sub">
                <a href="#">Pages</a>
                <ul >
                 <li><a href="{{ URL::to('/admin/about_us/create') }}">About Us</a></li>
                 <li><a href="{{ URL::to('/admin/terms/create') }}">terms</a></li>
                 <li><a href="{{ URL::to('/admin/policy/create') }}">policy</a></li>
              ...
              <li class="sub-with-sub">
                <a href="#">Faq</a>
                <ul >
                 <li><a href="{{ URL::to('/admin/faqs') }}">Faq </a></li>
                 <li><a href="{{ URL::to('/admin/faqs/create') }}">New</a></li>
               </ul>
             </li>
              <li class="">
                <a href="{{ URL::to('admin/contact_us') }}">Contact Us Requests 
                @if($contactus_requests_count > 0)
                <span class="fa fa-bell-o text-primary"></span><span class="text-primary">{{ @$contactus_requests_count }}</span>
                @endif
                </a>
                <ul>
          ...
          <div class="sub-item">
            <ul>
              ...
              <li class="sub-with-sub">
                <a href="#">Admin</a>
                <ul>
                  <li><a href="{{ URL::to('/admin/admins') }}">Admins List</a></li>
                  <li><a href="{{ URL::to('/admin/admins/create') }}">New</a></li>
                </ul>
              </li>
            </ul>
          </div><!-- dropdown-menu -->
            ...
            <ul>
              <li class="sub-with-sub">
                ...
                <ul>
                  ...
                  <li><a href="{{ URL::to('/admin/countries/create') }}">New</a></li>
                </ul>
              </li>
               <li class="sub-with-sub">
                <a href="#">Cities</a>
                <ul>
                  ...
                  <li><a href="{{ URL::to('/admin/cities/create') }}">New</a></li>
                </ul>
              </li>
            </ul>
          </div><!-- dropdown-menu -->
        ...
        <li class="nav-item with-sub ">
          ...
          <div class="sub-item">
            <ul>
              <li><a href="{{ URL::to('/admin/categories') }}">Categories List</a></li>
              <li><a href="{{ URL::to('/admin/categories/create') }}">New</a></li>
            </ul>
          </div><!-- dropdown-menu -->
        </li>
        ...
        <li class="nav-item with-sub ">
          ...
          <div class="sub-item">
            <ul>
              <li><a href="{{ URL::to('/admin/slider/create') }}">Slider</a></li>
              <li><a href="{{ URL::to('/admin/slider/create') }}">New</a></li>
            </ul>
          </div><!-- dropdown-menu -->
        </li>
  ...
  <script src="{{URL::to('/assets')}}/lib/datatables/js/jquery.dataTables.js"></script>
  <script src="{{URL::to('/assets')}}/lib/datatables-responsive/js/dataTables.responsive.js"></script>
  <script src="{{URL::to('/assets')}}/lib/summernote/js/summernote-bs4.min.js"></script>
  <script src="{{URL::to('/assets')}}/lib/jquery-ui/js/jquery-ui.js"></script>
  <script src="{{URL::to('/assets')}}/lib/medium-editor/js/medium-editor.js"></script>
  
  <script src="{{URL::to('/assets')}}/lib/moment/js/moment.js"></script>
  

  <script src="{{URL::to('/assets')}}/lib/fullcalendar/js/fullcalendar.js"></script>

{{-- Component --}}
  <script src="{{URL::to('/assets')}}/lib/jquery.maskedinput/js/jquery.maskedinput.js"></script>
  <script src="{{URL::to('/assets')}}/lib/bootstrap-tagsinput/js/bootstrap-tagsinput.js"></script>
