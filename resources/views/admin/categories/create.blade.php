...
<div class="slim-mainpanel">
  <div class="container">
    ...
    {{-- start form  --}}
     {!! Form::open(['method'=>'post','url'=>'admin/categories','class'=>"form-horizontal" ,'role'=>"form",'files'=>'true']) !!}
      <div class="slim-mainpanel">
        <div class="container">
            ...
            <div class="row row-sm mg-10">
              <div class="col-9 col-sm-8 col-xl-12">
                <label  ">name ar: <span class="tx-danger">*</span></label>
                 <input type="text" name="name_ar" class="form-control" value="{{ Request::old('name_ar') }}">
              </div><!-- col-8 -->
            </div><!-- row -->
            ...
            <div class="row row-sm mg-10">
              <div class="col-9 col-sm-8 col-xl-12">
                <label  ">name en: <span class="tx-danger">*</span></label>
                 <input type="text" name="name_en" class="form-control" value="{{ Request::old('name_en') }}">
              </div><!-- col-8 -->
            </div><!-- row -->
